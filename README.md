...
Building web interfaces, SPA web scrapers, high-load scripts, and server infrastructure.  
...
| :--- | :--- |
| **Frontend & Web** | Hand-crafted responsive layouts (HTML5, CSS3, Vanilla JS, React 19, Vite, Tailwind). Responsive grid from **320px**, PageSpeed **95+**, sub-second load times |
| **Scraping & Automation** | Real user emulation on complex JS websites with Playwright, SPA state analysis, session & proxy rotation |
| **Backend & APIs** | Asynchronous microservices on FastAPI / PHP 8, REST APIs, integrations with LLMs and AI vector models |
| **DevOps & VPS** | Linux Nginx reverse-proxy deployment, ECC SSL certificates via acme.sh, auto-renewal, systemd service isolation |

---

## Selected Projects

### 01. AUTOHELP24 — Emergency Roadside Assistance
> **Concept:** Emergency single-page interface for drivers stranded on highways. Symptom-based navigation instead of technical service names, instant arrival time, and floating call trigger.
...
### 02. CHISTO 52 — Cleaning Service Platform
> **Concept:** Commercial landing page for residential & commercial cleaning. Real-time cost calculator, interactive Leaflet 1.9 map integration, and trust transparency blocks.
...
### 03. ALINA — Editorial Nail Studio Landing
...
### 04. Stretch Ceilings Commercial Landing
...
### 05. Neon DevOps Portfolio & Cyberpunk Dashboard
